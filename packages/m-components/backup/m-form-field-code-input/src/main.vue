 ...
 * @LastEditTime: 2023-07-30 23:04:41
 * @FilePath: /zs-ui-vue2/packages/m-components/lib/components/m-form-item-code-input/src/main.vue
 * @TODO:既可以兼容原生js也可以使用eavl
-->
<template>
  <div class="code-container">
    <el-button size="mini" @click="visible = true">eidt code</el-button>
    <el-dialog
      title="code"

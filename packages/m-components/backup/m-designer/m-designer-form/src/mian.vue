 ...
 * @LastEditTime: 2023-07-30 21:24:23
  ...
  <div class="m-form-designer">
    ...
    <div class="m-form-designer__pannel">
      ...
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane label="formFields" name="formFields">
        ...
        <el-tab-pane label="formOptions" name="formOptions">
          <MFormGenerator ref="form" class="MFormGenerator" :form-option="formSetOption" />
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
...
import { MFormFieldButton } from '../../m-form-item-button/index'
...
export default {
  ...
  created(){
    // 编辑el-form 其他
    this.formSetOption.setOption({
      option: {
        size: 'mini',
        labelWidth: '120px'
      },
      formData: this.formOption.option,
      MDynamicFields: getItemForm('el-form')
    });
  },
  data() {
    return {
      ...
      getItemForm,
      activeName: 'formFields',
      formSetOption: new FormOption({})
    };
  },
  methods: {
